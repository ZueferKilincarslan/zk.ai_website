  ...
  return (
    <div className="min-h-screen gradient-bg">
      <Helmet>
        ...
        <meta name="description" content="Rechtliche Informationen und Kontaktdaten für ZK.AI." />
        <link rel="canonical" href="https://zk-ai.agency/de/impressum" />
          ...
          <div className="space-y-12">
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-4">Unternehmensangaben</h2>
                  <div className="text-gray-300 space-y-2">
                    <p>ZK.AI Automation & AI Solutions</p>
                    <p>Inhaber: Hüseyin Züfer Kilincarslan</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-4">Geschäftsadresse</h2>
                  <div className="text-gray-300 space-y-2">
                    <p>Nicht öffentlich gelistet</p>
                    <p>Deutschland</p>
                  </div>
                </div>
              </div>
