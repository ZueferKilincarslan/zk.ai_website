...
export const TixaeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // Cleanup function
    return () => {
      const convocoreScript = document.querySelector('script[data-convocore-script]');
      const voiceflowScript = document.querySelector('script[data-voiceflow-script]');
      
      if (convocoreScript && convocoreScript.parentNode) {
        convocoreScript.parentNode.removeChild(convocoreScript);
      }
      if (voiceflowScript && voiceflowScript.parentNode) {
        voiceflowScript.parentNode.removeChild(voiceflowScript);
      }
